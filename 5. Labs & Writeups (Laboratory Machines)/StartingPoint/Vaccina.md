## Enumeration
![Pasted image 20260910191826](img/Pasted%20image%2020260910191826.png)

Let's connect via ftp through an anonymous login
![Pasted image 20260910191845](img/Pasted%20image%2020260910191845.png)

We found the file, let's unpack it

![Pasted image 20260910191901](img/Pasted%20image%2020260910191901.png)
![Pasted image 20260910192358](img/Pasted%20image%2020260910192358.png)

We read the content and find a code fragment with confidential information

![Pasted image 20260910192115](img/Pasted%20image%2020260910192115.png)

2cb42f8734ea607eefed3b70af13bbd3  this is a password hash encrypted with the **MD5** algorithm

Decrypt with the help of the john the ripper tool

![Pasted image 20260910192620](img/Pasted%20image%2020260910192620.png)

Using this qwerty789 pass to login in to http server . 
...
Something interesting : uid=1000 default user but this is real user in sudo group and  can execute absolutely any command with root privileges.
